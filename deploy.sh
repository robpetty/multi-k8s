docker build -t rpetty2012/multi-client:latest -f rpetty2012/mutli-client:$SHA -f ./client/Dockerfile ./client
docker build -t rpetty2012/multi-server:latest -f rpetty2012/multi-server:$SHA -f ./server/Dockerfile ./server
docker build -t rpetty2012/multi-worker:latest -f rpetty2012/mutli-worker:$SHA -f ./worker/Dokcerfile ./worker
